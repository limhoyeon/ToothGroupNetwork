...
- trained checkpoints cannot be shared because of data copyright issue, so you have to train your model with your data. If you want test with our trained model, please request access in [Miccai2022 3D Teeth Scan Segmentation and Labeling Challenge](https://3dteethseg.grand-challenge.org/evaluation/final-test-3d-teeth-segmentation-and-labeling/leaderboard/) again. I'm sorry for the inconvenience.
