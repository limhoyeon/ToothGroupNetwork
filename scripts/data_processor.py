...
parser.add_argument('--sampling_num', required=False, default=24000, type=int, help="The number of points to sample")
parser.add_argument('--source_obj_data_path', required=False, default="example_data/org_data/obj_files", type=str, help="data path in which original .obj data are saved")
parser.add_argument('--source_json_data_path', required=False, default="example_data/org_data/json_files", type=str, help="data path in which original .json data are saved")
parser.add_argument('--save_data_path', required=False, default="example_data/processed_data", type=str, help="data path in which processed data will be saved")
